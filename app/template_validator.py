...
PRODUCT_TYPE_CONDITIONAL_FIELDS = {
    ...
    "SPORT_RACKET": {
        ...
        "Frame Material": "frame[marketplace_id=ATVPDKIKX0DER]#1.material[language_tag=en_US]#1.value",
        ...
        "Skill Level": "skill_level[marketplace_id=ATVPDKIKX0DER][language_tag=en_US]#1.value",
        ...
        "Included Components": "included_components[marketplace_id=ATVPDKIKX0DER][language_tag=en_US]#1.value",
        "Sport Type": "sport_type[marketplace_id=ATVPDKIKX0DER][language_tag=en_US]#1.value",
        "Grip Size": "grip[marketplace_id=ATVPDKIKX0DER]#1.size[language_tag=en_US]#1.value",
        "Grip Type": "grip[marketplace_id=ATVPDKIKX0DER]#1.type[language_tag=en_US]#1.value",
        "Hand Orientation": "hand_orientation[marketplace_id=ATVPDKIKX0DER][language_tag=en_US]#1.value",
        "Racket Performance Specialty": "racket_performance_specialty[marketplace_id=ATVPDKIKX0DER][language_tag=en_US]#1.value",
