# 花园艺手套_v1_upload.xlsx 写入报告

- 输出文件：/Users/admin/Desktop/上品模版填写上传/shangpin_system/data/projects/20260606_花园艺手套/05_填表版本/花园艺手套_v1_upload.xlsx
- 草稿来源：/Users/admin/Desktop/上品模版填写上传/shangpin_system/data/projects/20260606_花园艺手套/07_上架备注/花园艺手套_人工校准草稿_v1.xlsx
- 模板来源：/Users/admin/Desktop/上品模版填写上传/shangpin_system/data/projects/20260606_花园艺手套/04_模板原件/PROTECTIVE_GLOVE.xlsm
- 写入 SKU 数：3
- 写入字段数：39

## 关键字段

- SKU：GardenGlove-Purple-Violet
- Product Type：SHIRT
- Brand：Generic
- Manufacturer：Generic
- Item Type Keyword：garden-gloves
- List Price：4.99
- Haul Price：4.99
- Main Image URL：留空
...
- `::record_action`
- `base_coating_material[marketplace_id=ATVPDKIKX0DER][language_tag=en_US]#1.value`
- `batteries_included[marketplace_id=ATVPDKIKX0DER]#1.value`
...
- `glove_liner_material[marketplace_id=ATVPDKIKX0DER][language_tag=en_US]#1.value`
- `glove_or_mitt[marketplace_id=ATVPDKIKX0DER][language_tag=en_US]#1.value`
- `item_name[marketplace_id=ATVPDKIKX0DER][language_tag=en_US]#1.value`
- `item_package_dimensions[marketplace_id=ATVPDKIKX0DER]#1.height.unit`
- `item_package_dimensions[marketplace_id=ATVPDKIKX0DER]#1.height.value`
- `item_package_dimensions[marketplace_id=ATVPDKIKX0DER]#1.length.unit`
- `item_package_dimensions[marketplace_id=ATVPDKIKX0DER]#1.length.value`
- `item_package_dimensions[marketplace_id=ATVPDKIKX0DER]#1.width.unit`
- `item_package_dimensions[marketplace_id=ATVPDKIKX0DER]#1.width.value`
- `item_package_quantity[marketplace_id=ATVPDKIKX0DER]#1.value`
- `item_package_weight[marketplace_id=ATVPDKIKX0DER]#1.unit`
...
- `material[marketplace_id=ATVPDKIKX0DER][language_tag=en_US]#1.value`
- `model_number[marketplace_id=ATVPDKIKX0DER]#1.value`
- `number_of_items[marketplace_id=ATVPDKIKX0DER]#1.value`
- `palm_style[marketplace_id=ATVPDKIKX0DER][language_tag=en_US]#1.value`
